...
1.6.0 Addition of pentatonic tuning systems.
The `getModes`. method is deprecated in favour of the `freqiModes` property.
The `getMetaData` method is deprecated in favour of the `tuningSystemsData` property.
