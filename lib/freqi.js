(function (global, factory) {
  ...
  */
  function getIntervalAndMult(interval) {
      ...
      var _mult = Math.floor(_intervalAbs / PYTHAGOREAN.length);
      console.log('_mult', _mult);
      var _newInterval = _intervalAbs - (_mult * PYTHAGOREAN.length);
      console.log('_newInterval', _newInterval);
      return {
          mult: _mult,
