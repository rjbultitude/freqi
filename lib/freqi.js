(function (global, factory) {
  ...
  */
  ...
  var PYTHAGOREAN_RATIOS = [[1, 1], [256, 243], [9, 8], [32, 27], [81, 64], [4, 3], [729, 512], [3, 2], [128, 81], [27, 16], [16, 9], [243, 128]];
  var FIVE_LIMIT_RATIOS = [[1, 1], [16, 15], [9, 8], [6, 5], [5, 4], [4, 3], [64, 45], [3, 2], [8, 5], [5, 3], [9, 5], [15, 8]];
  var DIATONIC_RATIOS = [[1, 1], [9, 8], [5, 4], [4, 3], [3, 2], [5, 3], [15, 8]];
  var DIATONIC_INDIAN_RATIOS = [[1, 1], [9, 8], [5, 4], [4, 3], [3, 2], [27, 16], [15, 8]];
  var TWENTY_TWO_SHRUTI_RATIOS = [[1, 1], [256, 243], [16, 15], [10, 9], [9, 8], [32, 27], [6, 5], [5, 4], [81, 64], [4, 3], [27, 20], [45, 32], [729, 512], [3, 2], [128, 81], [8, 5], [5, 3], [27, 16], [16, 9], [9, 5], [15, 8], [243, 128]];
  var EQ_TEMP_STR = 'eqTemp';
  var PYTHAGOREAN_STR = 'pythagorean';
  var FIVE_LIMIT_STR = 'fiveLimit';
  var DIATONIC_STR = 'diatonic';
  var DIATONIC_INDIAN_STR = 'diatonicIndian';
  var TWENTY_TWO_SHRUTI_STR = '22Shrutis';
  ...
  */
  ...
  function getAllOctaveJustIntervals(interval, justIntervalsArr) {
      ...
      return {
          mult: _multF,
          arrLength: justIntervalsArr.length,
          origMult: _mult,
  ...
  function getJustIntervalsType(mode) {
      switch (mode) {
  ...
  function getJustIntNote(eTNoteConfig, _up) {
      var _justIntervalsArr = getJustIntervalsType(eTNoteConfig.mode);
