(function (global, factory) {
  ...
  var gioseffoZarlino = {
  	...
  	scaleType: "",
  	includesComma: false,
  	notes: "An unusual justly tuned 16 note scale designed for one of Zarlino's harpsichords"
  };
  var majorPentatonic = {
  	...
  	includesComma: false,
  	notes: "A major pentatonic scale"
  };
  var egyptianSuspended = {
  	...
  	scaleType: "pentatonic",
  	includesComma: false,
  	notes: "An Egyptian pentatonic scale otherwise known as suspended pentatonic"
  };
  var bluesMinorManGong = {
  	...
  	scaleType: "pentatonic",
  	includesComma: false,
  	notes: "An ancient Chinese pentatonic scale"
  };
  var bluesMajorRitsusenYo = {
  	name: "bluesMajorRitsusenYo",
  	shortName: "Blues major, Ritsusen (律旋)",
  	...
  	scaleType: "pentatonic",
  	includesComma: false,
  	notes: "A five-note scale without semitones used in the Japanese shōmyō chant"
  };
  var minorPentatonic = {
  	...
  	scaleType: "pentatonic",
  	includesComma: false,
  	notes: "A five-note minor pentatonic scale without semitones"
  };
