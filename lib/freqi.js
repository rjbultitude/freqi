(function (global, factory) {
  ...
  */
  ...
  function multByFifth(number) {
      var upperFifthRatio = 3 / 2;
      return number * upperFifthRatio;
  }
  function divByFifth(number) {
  ...
  function getTruePythagNote(eTNoteConfig, _up) {
      ...
      if (_up) {
          var noteFreq_1 = multByFifth(eTNoteConfig.startFreq);
          var prevNote_1 = noteFreq_1;
          for (var index = 1; index < eTNoteConfig.interval; index++) {
              noteFreq_1 = multByFifth(prevNote_1);
              prevNote_1 = noteFreq_1;
              if (index % 2 !== 0) {
                  noteFreq_1 = prevNote_1 / 2;
                  prevNote_1 = noteFreq_1;
              }
          }
          return noteFreq_1;
      }
      var noteFreq = divByFifth(eTNoteConfig.startFreq);
  ...
  function getNotesFromIntervals(pConfig) {
      ...
      if (pConfig.mode === 'truePythag') {
          _scaleArray = _scaleArray.sort();
      }
      return _scaleArray;
  }
  /**
