...
var gioseffoZarlino = {
	...
	shortName: "Gioseffo Zarlino just",
	longName: "Gioseffo Zarlino just intonation",
	intervalsInOctave: 19,
	type: "just",
	scaleType: "",
	notes: "TBC"
};
...
function getMetaData() {
    var newMetaDataObj = {};
    var modes = getModes();
    modes.array.forEach(function (mode) {
        Object.defineProperty(newMetaDataObj, mode, {
